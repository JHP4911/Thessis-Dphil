...
\label{sec:Small Angle X-ray Scattering}
    ...
    This is because Debye's equation, which describes the scattering intensities, $I_{Gauss}$, for molecules behaving as a Gaussian coils (equation \ref{eq:Debye function SAXS}), plateaus in a $q^2 \times I(q)$ vs $q$ plot within a limited range of data.
    \begin{equation}
        I_{Gauss}(q) = 2 I_0 \f{\exp(-u) + u -1}{u^2},
        \label{eq:Debye function SAXS}
    \end{equation}
    where $I_0$ is incident intensity and
    \begin{equation}
        u = q^2 R_g^2,
    \end{equation}
