...
\begin{figure}
    ...
    \begin{subfigure}[b]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/datared/tyrosine_insulin_1sig.png}
        \caption{}
	...
	\begin{subfigure}[b]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/datared/disulphide_insulin_1sig.png}
        \caption{}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{1.0\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figures/datared/prot_section2.png}
            \caption{}
    ...
    \begin{subfigure}[b]{1.0\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figures/datared/DNA_section2.png}
            \caption{}
...
The difference map between the amplitude values calculated from the ACT and FBA pipelines, using phases from the final model after refinement using the ACT amplitudes and the C.Esp1396I structure (PDB 3CLC) as a starting model, is shown in Figure~\ref{fig:Difference electron density map - C.Esp1396I}.
