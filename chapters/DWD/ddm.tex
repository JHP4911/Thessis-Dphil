...
\begin{table}[ht!]
	\caption{Pearson Correlation Coefficient (PCC) values for linearly transformed data. The values are negative showing the negative correlation between intensity and dose i.e. as the dose increases, the intensity decreases.}
	\centering
...
\begin{figure}
    ...
    \caption{Logarithm of the expected intensity values against resolution for 72 different protein crystals which were scaled together \cite{popov2003}. The proteins had different folds, molecular masses, space groups, data collection resolutions and were collected at different temperatures (both RT and cryo).}
