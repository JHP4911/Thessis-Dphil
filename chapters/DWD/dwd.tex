...
The remainder of this section presents the results of the analysis carried out with the data from Zeldin \textit{et al.} (2013) using the forms of $\eta$ given above, comparing their performance with the simple DWD (equation \ref{eq:DWD equation - no RDE}).
...
\begin{figure}
  \centering
    ...
    \caption[Dose isosurface map for the crystal used in the offset experiment described in Zeldin \textit{et al.} (2013).]{Dose isosurface map for the crystal used in the offset experiment. Isosurfaces are at 0.1 MGy (light blue), 5 MGy (dark blue) and 10 MGy (red). Note that the dose at any point in the crystal for the offset experiment is lower than the maximum dose for the standard strategy.}
...
\small
\captionsetup{justification=centering}
	\caption[Offset experiment design.]{The rows are presented in chronological order of the experiment. Syntax of the first column is: P1: 1st probe dataset, P2: 2nd probe dataset, HD: high dose dataset, -S: standard strategy, -O: offset strategy.}
	\centering
