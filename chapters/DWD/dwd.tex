...
\begin{figure}
  \centering
    ...
    \caption[Dose isosurface map for the crystal used in the offset experiment described in \cite{zeldin2013dwd}.]{Dose isosurface map for the crystal used in the offset experiment. Isosurfaces are at 0.1 MGy (light blue), 5 MGy (dark blue) and 10 MGy (red). Note that the dose at any point in the crystal for the offset experiment is lower than the maximum dose for the standard strategy.}
