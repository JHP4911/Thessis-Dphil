...
\textcolor{red}{
    \begin{myenumerate}
        \item \hypertarget{todo:includeFluiddynamics}{\textbf{TODO:} Include discussion on the fluid dynamics.}
    \end{myenumerate}
}
...
\textcolor{red}{
    \begin{myenumerate}
        \item \hypertarget{todo:SpecifyTest}{\textbf{TODO:} Specify the tests that need to be written}
    \end{myenumerate}
}
