...
The flux obtained using this formula was calibrated with an OSD1-0 photodiode purchased from Optoelectronics, which was a 500$\,\mu m$ thick silicon diode with a 1$\,$mm$^{\text{2}}$ active area as per \cite{owen2009}.
...
The data were recorded using a Dectris Pilatus 1M detector.
