...
\textcolor{red}{
    \begin{myenumerate}
        \item \hypertarget{todo:Fragmentation}{\textbf{TODO:} Need to discuss the idea of Fragmentation here}
    \end{myenumerate}
}
...
\begin{figure}
    ...
    \caption{1D scattering curves from the first run of the GI sample with no radioprotectant compounds added.
...
\begin{figure}
    ...
    \caption{Fidelity value as a function of time and dose. Fidelity values start at 0 for the first frame and increase as the frames become more dissimilar.}
...
A full explanation of the method can be found in \cite{franke2015correlation}, but the main ideas are presented here and tested for their suitability for applying to our data.
...
\end{figure}
It can be seen that if $m$ = 1, the spread of the apparent radiation damage onset is generally larger than for $m$ = 3, 5, 7, 10.
